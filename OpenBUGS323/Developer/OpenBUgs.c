/*	GNU General Public Licence
	...
	This small C program loads the LibOpenBUGS.so ELF shared library and calls the CLI function. 
	Save it as a .c file and then compile it on Linux using 
	
				gcc -o bugs OpenBUGS.c -ldl 
	
	This code should work on a Windows machine if LibOpenBUGS.so is repaced by LibOpenBUGS.dll
