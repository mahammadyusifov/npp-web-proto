...
import { cssObj } from "./style"; // 스타일 분리
import Logo from "@/assets/logo.svg";
import LogoutImage from "@/assets/logout.svg";
import { ROUTER } from "@/constants/ROUTER";
import { cssObj as cssObjNew} from "@/styles/statisticalStyle"
...
export default function StatisticalPage() {
  ...
  return (
    <>
      ...
      <main css={cssObjNew.container}>
        <h1 css={cssObjNew.title}>Statistical Methods</h1>

        {/* 1. Sensitivity Analysis */}
        <section css={cssObjNew.sectionBox}>
          ...
          <form onSubmit={handleSensitivitySubmit}>
            ...
            <label css={cssObjNew.labelSpacing}>
              Confidence Goal:
              <input
                type="text"
            ...
            <button type="submit" css={cssObjNew.button}>Submit</button>
          </form>
          {numTests && <p css={cssObjNew.output}>Output - {numTests}</p>}
        </section>
        ...
        <section css={cssObjNew.sectionBox}>
          ...
          <button css={cssObjNew.button} onClick={handleFullAnalysisSubmit}>
            Run Full Analysis and Save
          </button>
          {fullResultPath && (
            <p css={cssObjNew.output}>
